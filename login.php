...
"  make it display something like image of a mobile phone in the bg.


I'll update the login UI to include a mobile phone image in the background. I'll modify the HTML and CSS to add a background image while keeping the existing functionality intact. I'll use a subtle mobile phone image that complements the existing design.
...
Can you do a very reasonable UI/UX for this page "<?php include 'includes/session.php'; ?>
<?php
  if(isset($_SESSION['user'])){
    header('location: cart_view.php');
  }
